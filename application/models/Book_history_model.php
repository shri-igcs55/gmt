    ...
    function book_history($input)
    {
		...
		$this->db->join('gmt_status h', 'h.sta_id = a.plc_odr_status_id_fk', 'left');
		  ...
		  if($input['order_status'] == 3){
			...
			$this->db->where('plc_odr_status_id_fk <=', 9);
