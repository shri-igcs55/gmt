<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class User extends REST_Controller
	{
		...
		public function user_signup_post()
		{
            ...
            $ip['thumb_image']      = trim($this->input->post('thumb_image'));
			...
			$ip_array[] = array("first_name", $ip['first_name'], "not_null", "first_name", "First name is empty.");
			$ip_array[] = array("address1", $ip['address1'], "not_null", "address1", "Address is empty.");
			$ip_array[] = array("state", $ip['state'], "not_null", "state", "State is empty.");
			$ip_array[] = array("district", $ip['district'], "not_null", "district", "District is empty.");
			$ip_array[] = array("city", $ip['city'], "not_null", "city", "City is empty.");
			$ip_array[] = array("pin", $ip['pin'], "not_null", "pin", "Pin is empty.");
			if($ip['user_type']==4)
			{
                $ip_array[] = array("company_type", $ip['company_type'], "not_null", "company_type", "Company Type is empty.");
			    $ip_array[] = array("designation", $ip['designation'], "not_null", "designation", "Designation is empty.");
			}
			if($ip['user_type']== 4||$ip['user_type']== 5||$ip['user_type']==6||$ip['user_type']==8||$ip['user_type']==9||$ip['user_type']==10||$ip['user_type']==11||$ip['user_type']==12)
			{
				$ip_array[] = array("firm_name", $ip['firm_name'], "not_null", "firm_name", "Firm name is empty.");
			    $ip_array[] = array("pan", $ip['pan'], "not_null", "pan", "Pan is empty.");
			}
