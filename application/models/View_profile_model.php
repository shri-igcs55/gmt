<?php if(! defined('BASEPATH')) exit('No direct script access allowed');
	...
	*/
    ...
    function view_profile($input)
    {
    	...
    	$this->db->select('b.user_id AS id, b.user_fname AS fname, b.user_lname AS lname, b.user_email AS email, b.user_mob AS mobile, d.id AS c_id, d.city, a.state_fk AS state, d.district AS dstrt, a.address1 AS addr1, a.address2 AS addr2, a.u_detail_pin AS pincode, a.u_detail_pan AS pan_no, a.u_detail_tin AS tin_no, a.u_detail_stax AS stax, IFNULL(e.comp_type, 0) AS company_type, c.u_type_name AS user_type_name');
